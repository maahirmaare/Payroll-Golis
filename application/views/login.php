...
<body>
  <div class="container">
    <div class="img">
      <img src="<?php echo base_url(); ?>assets/landing/img/hadda trends design payroll.svg">
    </div>
    <div class="login-content">
      <form class="user" method="POST" action="<?php echo base_url('login') ?>">
        <img src="<?php echo base_url(); ?>assets/landing/img/crop.png">
        <h2 class="title">Payroll Application</h2>
