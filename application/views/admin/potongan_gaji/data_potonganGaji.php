<button type="button" class="tambah btn-sm btn-success mb-3" data-toggle="modal" data-target="#myModal"><i class="fas fa-plus"></i> Add Pay Cut</button>
        ...
        <div class="modal-dialog">
            ...
            <!-- Modal Header -->
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn btn-sm btn-danger" data-dismiss="modal">Cancel</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                <thead class="thead-dark">
                    <tr>
                        <th>No</th>
                        <th>Salary Pay Cuts</th>
                        <th>Total Pay Cuts</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Sh.so. <?php echo number_format($item->jml_potongan,0,',','.') ?></td>
                        <td>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                document.getElementById("judul").innerHTML='Add Pay Cuts';
        ...
        $('.edit').click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    $('#myModal').modal("show");
                    $('#tampil_modal').html(data);
                    document.getElementById("judul").innerHTML='Edit Pay cuts';  
                }
            });
        });
        ...
        $('.hapus').click(function(){
            ...
            $.ajax({
                ...
                success:function(data){
                    $('#myModal').modal("show");
                    $('#tampil_modal').html(data);
                    document.getElementById("judul").innerHTML='Delete Cuts';
                }
            });
            });
    });
